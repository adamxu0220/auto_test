...
node('build_server') {
    ...
    stage('GerritReviewer'){
        common_api.jenkins_reviewer_pretest(GERRIT_HOST, GERRIT_PORT, GERRIT_CHANGE_NUMBER, GERRIT_PATCHSET_NUMBER, res_stage_get_pure_sourcecode && res_stage_get_CL && res_stage_build)
    }
